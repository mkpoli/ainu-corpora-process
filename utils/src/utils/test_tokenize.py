...
def test_tokenize():
    TEST_CASES = [
        ...
        [
            "korka, katkemat'utar anakne uweyaykopuntek kor suke kor okay korka asinuma anakne suke ka=an ki somo ki no, soy peka omanan=an w_a inkar=an korka kuca okari (e)nep ka omanan ruwe ka isam no, siran w_a a=nukar korka inawcipa kes ta hemanta sirouri wa tumamaha anakne nuyna wa, sapa takupi sanke wa an pe an ruwe a=nukar wa kusu, a=hokuhu poro su ka kor wa arpa, kuca or_ ta kor wa arpa wa an pe ne kusu ne su a=atte wa useykar=an w_a *popse ... pop'useykar=an wa ne sapaha takup sanke wa an pe, sapaha a=kuta*3 akusu",
            [
                "korka",
                "katkemat'utar",
                "anakne",
